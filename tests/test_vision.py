...
from friday.vision import describe_image, vision_ready, masked_vision_key
...
def test_vision_ready_requires_enabled_and_key():
    ...
    assert vision_ready(UserSettings(vision_enabled=True, vision_api_key="ark-test-key-12345678"))
...
def test_describe_image_missing_file(tmp_path: Path):
    settings = UserSettings(vision_enabled=True, vision_api_key="ark-test-key-12345678")
