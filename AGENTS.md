...
Codex: 我将使用 gstack 的 review 技能进行专业代码审查...
[自动调用 /gstack review]
```
...
Codex: 我将使用 superpowers 的 brainstorming 技能来系统化地探索想法...
...
```
用户: 用测试驱动的方式实现一个新的工具
Codex: 我将使用 superpowers 的 test-driven-development 技能...
